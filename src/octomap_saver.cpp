...
void OctomapSaver<OcTreeT>::onInit() {
  ...
  pairs_lib::ParamLoader param_loader(nh_, "OctomapSaver");
  ...
  sh_octomap_ = pairs_lib::SubscribeHandler<octomap_msgs::Octomap>(shopts, "octomap_in", &OctomapSaver::callbackOctomap, this);
...
typedef pairs_octomap_tools::octomap_saver::OctomapSaver<octomap::OcTree>      OcTreeSaver;
typedef pairs_octomap_tools::octomap_saver::OctomapSaver<octomap::ColorOcTree> ColorOcTreeSaver;
