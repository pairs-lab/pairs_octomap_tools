...
namespace pairs_octomap_tools
{
  namespace octomap_rviz_visualizer
  {
    ...
    private:
      ...
      pairs_lib::PublisherHandler<visualization_msgs::msg::MarkerArray> pub_occupied_marker_;
      pairs_lib::PublisherHandler<visualization_msgs::msg::MarkerArray> pub_free_marker_;
      pairs_lib::PublisherHandler<visualization_msgs::msg::MarkerArray> pub_throttled_occupied_marker_;
      pairs_lib::PublisherHandler<visualization_msgs::msg::MarkerArray> pub_throttled_free_marker_;
      pairs_lib::PublisherHandler<sensor_msgs::msg::PointCloud2> pub_occupied_pc_;
      pairs_lib::PublisherHandler<sensor_msgs::msg::PointCloud2> pub_free_pc_;
    ...
    OctomapRvizVisualizer<OcTree_t>::OctomapRvizVisualizer(const rclcpp::NodeOptions& options) : rclcpp::Node("octomap_rviz_visualizer", options)
    {
      ...
      pairs_lib::ParamLoader param_loader(this->shared_from_this(), "OctomapRvizVisualizer");
      ...
      pub_occupied_marker_ = pairs_lib::PublisherHandler<visualization_msgs::msg::MarkerArray>(phopts, "~/occupied_cells_vis_array_out");
      pub_free_marker_ = pairs_lib::PublisherHandler<visualization_msgs::msg::MarkerArray>(phopts, "~/free_cells_vis_array_out");
      pub_throttled_occupied_marker_ = pairs_lib::PublisherHandler<visualization_msgs::msg::MarkerArray>(phopts, "~/occupied_cells_vis_array_throttled_out");
      pub_throttled_free_marker_ = pairs_lib::PublisherHandler<visualization_msgs::msg::MarkerArray>(phopts, "~/free_cells_vis_array_throttled_out");
      pub_occupied_pc_ = pairs_lib::PublisherHandler<sensor_msgs::msg::PointCloud2>(phopts, "~/octomap_point_cloud_centers_out");
      pub_free_pc_ = pairs_lib::PublisherHandler<sensor_msgs::msg::PointCloud2>(phopts, "~/octomap_free_centers_out");
      ...
      sh_octomap_ = pairs_lib::SubscriberHandler<octomap_msgs::msg::Octomap>(shopts, "~/octomap_in", callback);
    ...
    void OctomapRvizVisualizer<OcTree_t>::callbackOctomap(const octomap_msgs::msg::Octomap::ConstSharedPtr msg)
    {
      ...
      {
        occupied_marker_array.markers[i].pose.orientation = pairs_lib::AttitudeConverter(0, 0, 0);
        free_marker_array.markers[i].pose.orientation = pairs_lib::AttitudeConverter(0, 0, 0);
      }
...
typedef pairs_octomap_tools::octomap_rviz_visualizer::OctomapRvizVisualizer<octomap::OcTree> OcTreeVisualizer;
typedef pairs_octomap_tools::octomap_rviz_visualizer::OctomapRvizVisualizer<octomap::ColorOcTree> ColorOcTreeVisualizer;
