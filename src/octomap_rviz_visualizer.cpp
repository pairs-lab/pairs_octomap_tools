...
void OctomapRvizVisualizer<OcTree_t>::onInit() {
  ...
  pairs_lib::ParamLoader param_loader(nh_, "OctomapRvizVisualizer");
  ...
  sh_octomap_ = pairs_lib::SubscribeHandler<octomap_msgs::Octomap>(shopts, "octomap_in", &OctomapRvizVisualizer::callbackOctomap, this);
