...
# dependency .debs from /prebuilt, then builds pairs_octomap_tools and copies the .deb to /output.
...
LOCAL_RULES="/src/pairs_octomap_tools/packaging/rosdep/pairs.yaml"
...
build_one /src/pairs_octomap_tools
